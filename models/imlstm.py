...
class ImbalancedLSTM(tf.keras.Model):
    ...
    def __init__(self, units, cls_num, layers=1, max_m = 0.5, dropout=0.5, name='lstm', lr=1e-3):
        super(ImbalancedLSTM, self).__init__()
        self._units = units
        self._name  = name
        self.num_layers = layers
        self.n_classes = cls_num.shape[0]
    ...
    def get_loss(self, y_true, y_pred, masks):
        ...
        loss = self.ldam_loss(y_expanded, y_pred)
